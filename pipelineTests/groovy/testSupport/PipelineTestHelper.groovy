...
class PipelineTestHelper extends BasePipelineTest {
    ...
    void registerScriptedMethods() {
        ...
        helper.registerAllowedMethod('withCredentials', [Map.class, Closure.class], { List list, Closure c ->
        ...
        helper.registerAllowedMethod('hipchatSend', [java.util.LinkedHashMap.class], null)
        helper.registerAllowedMethod('configFile', [java.util.LinkedHashMap], null)
        helper.registerAllowedMethod('configFileProvider', [java.util.ArrayList, Closure.class], null)
    ...
    void setJobVariables() {
        ...
        binding.setVariable('RUN_DISPLAY_URL', "the jenkinsUrl")
        binding.setVariable('RUN_CHANGES_DISPLAY_URL', "the jenkinsUrl")
        /**
